const stats = [
  { value: "15+", label: "Years of Experience", description: "Deep expertise in digital forensics and legal technology" },
  { value: "500+", label: "Investigations Completed", description: "Across industries and jurisdictions worldwide" },
  { value: "10K+", label: "Artifacts Analyzed", description: "Devices, documents, and data sources examined" },
  { value: "12+", label: "Industries Served", description: "From finance to healthcare to technology" },
];

const features = [
  {
    title: "Enterprise-Grade Security",
    description: "SOC 2 compliant processes with end-to-end encryption and strict access controls.",
    icon: (
  ...
  },
  {
    ...
    description: "Court-tested procedures that withstand legal scrutiny and regulatory review.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Round-the-clock availability for critical incidents with guaranteed response times.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-zinc-400">
              Our track record speaks for itself. We combine deep technical expertise with rigorous methodology to deliver results that stand up to scrutiny.
            </p>
